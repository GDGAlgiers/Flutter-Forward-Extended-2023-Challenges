...
class _VersesWidgetState extends State<VersesWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      if (Buildcc().read<BookmarkVersesCubit>().state.isBookmark) {
        setState(() {
          isBookmark = true;
        });
      } else {
  ...
  Future<void> setAudioUrl() async {
    await widget.player.setAudioSource(widget.bookmark.audioUri as AudioSource);
  }
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (processingState == ProcessingState.loading ||
                      ...
                      return InkWell(
                        ...
                        borderRadius: BorderRadius.circular(10.0),
                        child: Image.asset('assets/icn_play.png', width: 16.0),
                      );
